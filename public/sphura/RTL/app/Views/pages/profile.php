															...
															<div class="col-12">
																<div class="card mg-b-20 border">
																		...
																		<div class="media">
																			...
																			<div class="mr-auto">
																				<div class="dropdown show"> <a class="new option-dots2" data-toggle="dropdown" href="JavaScript:void(0);"><i class="fas fa-ellipsis-v"></i></a>
																					<div class="dropdown-menu border  shadow"> <a class="dropdown-item" href="#">Edit Post</a> <a class="dropdown-item" href="#">Delete Post</a> <a class="dropdown-item" href="#">Personal Settings</a> </div>
																				</div>
																			</div>
																		</div>
																	</div>
																	<div class="card-body">
																		...
																		<div class="row row-sm">
																			<div class="col"> <img alt="img" class="wd-200 ml-4" src="<?php echo base_url('public/assets/img/media/1.jpg'); ?>"> <img alt="img" class="wd-200" src="<?php echo base_url('public/assets/img/media/2.jpg'); ?>"> </div>
																		</div>
																...
																<div class="card mg-b-20 border">
																	...
																	<div class="card-body h-100">
																		<p class="mg-t-0">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</p>
																		<div class="row row-sm">
																			<div class="col"> <img alt="img" class="wd-200 ml-4" src="<?php echo base_url('public/assets/img/media/4.jpg'); ?>"> <img alt="img" class="wd-200" src="<?php echo base_url('public/assets/img/media/5.jpg'); ?>"> </div>
																		</div>
																		<div class="media mg-t-15 profile-footer">
																			<div class="media-user ml-2">
																				<div class="demo-avatar-group">
																...
																<div class="card border">
																	...
																	<div class="card-body h-100">
																		<p class="mg-t-0">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</p>
																		<div class="row row-sm">
																			<div class="col"> <img alt="img" class="wd-200 ml-3" src="<?php echo base_url('public/assets/img/media/4.jpg'); ?>"> <img alt="img" class="wd-200" src="<?php echo base_url('public/assets/img/media/7.jpg'); ?>"> </div>
																		</div>
																		<div class="media mg-t-15 profile-footer">
																			<div class="media-user ml-2">
																				<div class="demo-avatar-group">
														...
														<div class="card custom-card border">
															<div class="card-body text-center">
																<div class="user-lock text-center">
																	<div class="dropdown text-left">
																		<a href="#" class="option-dots" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"> <i class="fe fe-more-vertical"></i> </a>
																		<div class="dropdown-menu border shadow"> <a class="dropdown-item" href="#"> Message<i class="fe fe-message-square ml-2"></i></a> <a class="dropdown-item" href="#"> Edit<i class="fe fe-edit-2 ml-2"></i></a> <a class="dropdown-item" href="#"> View<i class="fe fe-eye ml-2"></i></a> <a class="dropdown-item" href="#"> Delete<i class="fe fe-trash-2 ml-2"></i></a> </div>
																	</div> <img alt="avatar" class="rounded-circle" src="<?php echo base_url('public/assets/img/users/8.jpg'); ?>"> </div>
																<h5 class="mb-1 mt-3 main-content-label">Stephen Metcalfe</h5>
																<p class="mb-2 mt-1 tx-inverse">Administrator</p>
																<p class="text-muted text-center mt-1">Lorem Ipsum is not simply popular belief Contrary.</p>
