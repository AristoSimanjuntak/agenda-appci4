							...
							<div class="col-xxl-4 col-xl-12 col-lg-12 col-md-12">
								<div class="card custom-card">
									...
									<div class="card-body pt-1">
										<div class="d-flex">
											<img src="<?php echo base_url('public/assets/img/svgs/crypto-currencies/btc.svg'); ?>" class="wd-40 ht-40 ml-3 my-auto" alt="">
											<div class="">
								...
								<div class="card custom-card">
									...
									<div class="card-body p-3">
										<div class="d-flex"><img src="<?php echo base_url('public/assets/img/svgs/crypto-currencies/btc.svg'); ?>" class="wd-30 ht-30 ml-3 my-auto" alt="img">
											<div class="mt-1">
									...
									<div class="card-body p-3">
										<div class="d-flex"><img src="<?php echo base_url('public/assets/img/svgs/crypto-currencies/dash.svg'); ?>" class="wd-30 ht-30 ml-3 my-auto" alt="img">
											<div class="mt-1">
									...
									<div class="card-body p-3">
										<div class="d-flex"><img src="<?php echo base_url('public/assets/img/svgs/crypto-currencies/miota.svg'); ?>" class="wd-30 ht-30 ml-3 my-auto" alt="img">
											<div class="mt-1">
										...
										<div class="card custom-card wallet">
											<div class="card-body">
												...
												<div class="d-flex mt-4">
													<img src="<?php echo base_url('public/assets/img/svgs/crypto-currencies/eth.svg'); ?>" class="wd-40 ht-40 ml-3 my-auto" alt="">
													<div class="">
													...
													<img src="<?php echo base_url('public/assets/img/pngs/qrcode.png'); ?>" class="wd-50 ht-50  my-auto mr-auto float-right" alt="">
												</div>
									...
									<div class="col-xl-6 col-lg-12 col-md-12">
										<div class="card custom-card wallet">
											<div class="card-body">
												...
												<br>
												<div class="d-flex mt-4">
													<img src="<?php echo base_url('public/assets/img/svgs/crypto-currencies/xrp.svg'); ?>" class="wd-40 ht-40 ml-3 my-auto" alt="">
													<div class="">
									...
									<div class="col-xl-6 col-lg-12 col-md-12">
										<div class="card custom-card wallet">
											<div class="card-body">
												...
												<br>
												<div class="d-flex mt-4">
													<img src="<?php echo base_url('public/assets/img/svgs/crypto-currencies/dash.svg'); ?>" class="wd-40 ht-40 ml-3 my-auto" alt="">
													<div class="">
									...
									<div class="col-xl-6 col-lg-12 col-md-12">
										<div class="card custom-card wallet">
											<div class="card-body">
												...
												<br>
												<div class="d-flex mt-4">
													<img src="<?php echo base_url('public/assets/img/svgs/crypto-currencies/ltc.svg'); ?>" class="wd-40 ht-40 ml-3 my-auto" alt="">
													<div class="">
