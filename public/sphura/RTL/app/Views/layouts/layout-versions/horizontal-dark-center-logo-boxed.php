	    ...
	    <div class="page">
				...
				<div class="container">
					<div class="main-header-left">
						...
						<a class="main-logo" href="<?php echo base_url('pages/index'); ?>">
							<img src="<?php echo base_url('public/assets/img/brand/logo.png'); ?>" class="header-brand-img desktop-logo" alt="logo">
							<img src="<?php echo base_url('public/assets/img/brand/logo-light.png'); ?>" class="header-brand-img desktop-logo theme-logo" alt="logo">
						</a>
					</div>
					...
					<div class="main-header-right">
						...
						<a class="header-brand2" href="<?php echo base_url('pages/index'); ?>">
								<img src="<?php echo base_url('public/assets/img/brand/logo.png'); ?>" class="logo-white top-header-logo1">
								<img src="<?php echo base_url('public/assets/img/brand/logo-light.png'); ?>" class="logo-default top-header-logo2">
						</a>
			...
			<div class="main-navbar hor-menu sticky">
				<div class="container">
					<ul class="nav">
						<li class="nav-item">
							<a class="nav-link with-sub" href=""><i class="ti-home"></i>Dashboards</a>
							<ul class="nav-sub">
								<li class="nav-sub-item">
									<a class="nav-sub-link" href="<?php echo base_url('pages/index'); ?>">Project Dashboard</a>
								</li>
								<li class="nav-sub-item">
									<a class="nav-sub-link with-sub" href="#">Crypto Currencies</a>
									<ul class="nav-sub">
										<li class="nav-sub-item">
								...
								<li class="nav-sub-item">
									<a class="nav-sub-link with-sub" href="#">Ecommerce</a>
									<ul class="nav-sub">
										<li class="nav-sub-item">
						...
						<li class="nav-item">
							<a class="nav-link with-sub" href=""><i class="ti-layout"></i>Layouts</a>
							<ul class="nav-sub">
								<li class="nav-sub-item">
									<a class="nav-sub-link with-sub" href="#">Horizontal</a>
									<ul class="nav-sub">
										<li class="nav-sub-item">
								...
								<li class="nav-sub-item">
									<a class="nav-sub-link with-sub" href="#">Horizontal-Centerlogo</a>
									<ul class="nav-sub">
										<li class="nav-sub-item">
								...
								<li class="nav-sub-item">
									<a class="nav-sub-link with-sub" href="#">Sidemenu-Icon</a>
									<ul class="nav-sub">
										<li class="nav-sub-item">
								...
								<li class="nav-sub-item">
									<a class="nav-sub-link with-sub" href="#">Sidemenu-Closed</a>
									<ul class="nav-sub">
										<li class="nav-sub-item">
								...
								<li class="nav-sub-item">
									<a class="nav-sub-link with-sub" href="#">Sidemenu-Toggle</a>
									<ul class="nav-sub">
										<li class="nav-sub-item">
								...
								<li class="nav-sub-item">
									<a class="nav-sub-link with-sub" href="#">Sidemenu-Icontext</a>
									<ul class="nav-sub">
										<li class="nav-sub-item">
								...
								<li class="nav-sub-item">
									<a class="nav-sub-link with-sub" href="#">Sidemenu-Iconoverlay</a>
									<ul class="nav-sub">
										<li class="nav-sub-item">
								...
								<li class="nav-sub-item">
									<a class="nav-sub-link with-sub" href="#">Menu-hoversubmenu</a>
									<ul class="nav-sub">
										<li class="nav-sub-item">
								...
								<li class="nav-sub-item">
									<a class="nav-sub-link with-sub" href="#">Menu-hoversubmenu-1</a>
									<ul class="nav-sub">
										<li class="nav-sub-item">
						...
						<li class="nav-item">
							...
							<ul class="nav-sub">
								<li class="nav-sub-item">
									<a class="nav-sub-link" href="<?php echo base_url('pages/widgets'); ?>">Widgets</a>
								</li>
								<li class="nav-sub-item">
						...
						<li class="nav-item">
							...
							<ul class="nav-sub">
								...
								<li class="nav-sub-item">
									<a class="nav-sub-link with-sub" href="<?php echo base_url('pages/pricing'); ?>">Alertpages</a>
									<ul class="nav-sub">
										<li class="nav-sub-item">
