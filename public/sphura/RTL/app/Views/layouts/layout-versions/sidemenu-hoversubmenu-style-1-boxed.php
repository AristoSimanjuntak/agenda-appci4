...
<html lang="en" dir="rtl" >
	<head>
		...
		<!-- Sidemenu css-->
		<link href="<?php echo base_url('public/assets/css-rtl/sidemenu/sidemenu4.css') ?>" rel="stylesheet">
	...
	<body class="main-body leftmenu">
				...
				<div class="main-sidebar-body">
					<ul class="nav">
						...
						<li class="nav-item submenu-style">
							...
							<ul class="nav-sub">
                            <li class="side-menu-label1"><a href="#">Layouts</a></li>
						...
						<li class="nav-item">
							...
							<ul class="nav-sub">
							 <li class="side-menu-label1"><a href="#">Icons</a></li>
								<li class="nav-sub-item">
									<a class="nav-sub-link" href="<?php echo base_url('pages/icons'); ?>">Font Awesome</a>
								</li>
								<li class="nav-sub-item">
		...
		<!-- Sidemenu js -->
		<script src="<?php echo base_url('public/assets/plugins/sidemenu/sidemenu1-rtl.js') ?>"></script>
