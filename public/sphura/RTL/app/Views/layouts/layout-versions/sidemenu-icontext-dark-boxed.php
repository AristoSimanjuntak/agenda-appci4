...
<html lang="en" dir="rtl" >
	<head>
		...
		<!-- Style css-->
		<link href="<?php echo base_url('public/assets/css-rtl/style.css') ?>" rel="stylesheet">
		<link href="<?php echo base_url('public/assets/css-rtl/boxed.css') ?>" rel="stylesheet" />
		<link href="<?php echo base_url('public/assets/css-rtl/dark-boxed.css') ?>" rel="stylesheet" />
		<link href="<?php echo base_url('public/assets/css-rtl/skins.css') ?>" rel="stylesheet">
		<link href="<?php echo base_url('public/assets/css-rtl/dark-style.css') ?>" rel="stylesheet">
		<link href="<?php echo base_url('public/assets/css-rtl/colors/default.css') ?>" rel="stylesheet">

		<!-- Color css-->
		<link id="theme" rel="stylesheet" type="text/css" media="all" href="<?php echo base_url('public/assets/css-rtl/colors/color.css') ?>">
		...
		<!-- Sidemenu css-->
		<link href="<?php echo base_url('public/assets/css-rtl/sidemenu/sidemenu2.css') ?>" rel="stylesheet">

		<!-- Switcher css-->
		<link href="<?php echo base_url('public/assets/switcher/css/switcher-rtl.css'); ?>" rel="stylesheet">
		<link href="<?php echo base_url('public/assets/switcher/demo.css'); ?>" rel="stylesheet">
	...
	<body class="main-body leftmenu dark-theme">
			...
			<div class="main-sidebar main-sidebar-sticky side-menu">
				...
				<div class="main-sidebar-body">
					<ul class="nav">
						...
						<li class="nav-item">
							<a class="nav-link with-sub" href="#"><span class="shape1"></span><span class="shape2"></span><i class="ti-layout sidemenu-icon"></i><span class="sidemenu-label">Layouts</span><i class="angle fe fe-chevron-left"></i></a>
							<ul class="nav-sub">
								<li class="nav-sub-item">
									<a class="nav-sub-link with-sub" href="#"></span><span class="sidemenu-label">Horizontal</span><i class="angle fe fe-chevron-left"></i></a>
									<ul class="nav-sub">
										<li class="nav-sub-item">
								...
								<li class="nav-sub-item">
									<a class="nav-sub-link with-sub" href="#"></span><span class="sidemenu-label">Horizontal-Centerlogo</span><i class="angle fe fe-chevron-left"></i></a>
									<ul class="nav-sub">
										<li class="nav-sub-item">
								...
								<li class="nav-sub-item">
									<a class="nav-sub-link with-sub" href="#"></span><span class="sidemenu-label">Sidemenu-Icon</span><i class="angle fe fe-chevron-left"></i></a>
									<ul class="nav-sub">
										<li class="nav-sub-item">
								...
								<li class="nav-sub-item">
									<a class="nav-sub-link with-sub" href="#"></span><span class="sidemenu-label">Sidemenu-Closed</span><i class="angle fe fe-chevron-left"></i></a>
									<ul class="nav-sub">
										<li class="nav-sub-item">
								...
								<li class="nav-sub-item">
									<a class="nav-sub-link with-sub" href="#"></span><span class="sidemenu-label">Sidemenu-Toggle</span><i class="angle fe fe-chevron-left"></i></a>
									<ul class="nav-sub">
										<li class="nav-sub-item">
								...
								<li class="nav-sub-item">
									<a class="nav-sub-link with-sub" href="#"></span><span class="sidemenu-label">Sidemenu-Icontext</span><i class="angle fe fe-chevron-left"></i></a>
									<ul class="nav-sub">
										<li class="nav-sub-item">
								...
								<li class="nav-sub-item">
									<a class="nav-sub-link with-sub" href="#"></span><span class="sidemenu-label">Sidemenu-Iconoverlay</span><i class="angle fe fe-chevron-left"></i></a>
									<ul class="nav-sub">
										<li class="nav-sub-item">
								...
								<li class="nav-sub-item">
									<a class="nav-sub-link with-sub" href="#"></span><span class="sidemenu-label">Menu-hoversubmenu</span><i class="angle fe fe-chevron-left"></i></a>
									<ul class="nav-sub">
										<li class="nav-sub-item">
								...
								<li class="nav-sub-item">
									<a class="nav-sub-link with-sub" href="#"></span><span class="sidemenu-label">Menu-hoversubmenu-1</span><i class="angle fe fe-chevron-left"></i></a>
									<ul class="nav-sub">
										<li class="nav-sub-item">
				...
				<div class="container-fluid">
					...
					<div class="main-header-right">
						...
						<div class="dropdown main-header-notification">
							...
							<div class="dropdown-menu">
							<div class="header-navheading">
								<p class="main-notification-text tx-medium text-right"> 3 New messages </p>
							</div>
							<div class="main-notification-list">
							   <div class="media new">
		...
		<script src="<?php echo base_url('public/assets/plugins/bootstrap/js/bootstrap-rtl.js'); ?>"></script>
		...
		<!-- Sidemenu js -->
		<script src="<?php echo base_url('public/assets/plugins/sidemenu/sidemenu2-rtl.js') ?>"></script>

		<!-- Sidebar js -->
		<script src="<?php echo base_url('public/assets/plugins/sidebar/sidebar-rtl.js') ?>"></script>
