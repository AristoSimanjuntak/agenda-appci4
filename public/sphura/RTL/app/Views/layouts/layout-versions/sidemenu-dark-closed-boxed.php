...
<html lang="en" dir="rtl" >
	<head>
		...
		<!-- Sidemenu css-->
		<link href="<?php echo base_url('public/assets/css-rtl/sidemenu/sidemenu-closed.css') ?>" rel="stylesheet">
	...
	<body class="main-body leftmenu dark-theme">
		...
		<!-- Sidemenu js -->
		<script src="<?php echo base_url('public/assets/plugins/sidemenu/sidemenu-rtl.js') ?>"></script>
