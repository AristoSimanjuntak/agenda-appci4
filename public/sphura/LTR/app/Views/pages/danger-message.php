					...
					<div class="card alert-message">
						<div class="card-body">
							<div class="text-center text-white">
								...
								<p class="tx-18 text-white-50">Oops!! You tried to access a page which is not available.</p>
								<a href="<?php echo base_url('pages/index'); ?>" class="btn btn-danger">Back to Home</a>
							</div>
						</div>
					</div>
				</div>
