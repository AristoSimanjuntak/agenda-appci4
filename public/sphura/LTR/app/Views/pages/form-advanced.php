<?= $this->include('layouts/verticalmenu/header'); ?>
		...
		<link rel="stylesheet" href="<?php echo base_url('public/assets/plugins/telephoneinput/telephoneinput.css'); ?>">
	...
	<?= $this->include('layouts/verticalmenu/master'); ?>
		...
		<script src="<?php echo base_url('public/assets/plugins/fileuploads/js/fileupload.j'); ?>s"></script>
