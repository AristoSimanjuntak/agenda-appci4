												...
												<div class="">
													<ul class="list-group">
														<li class="list-group-item d-flex align-items-center">
															<img alt="avatar" class="wd-30 rounded-circle mg-r-15" src="<?php echo base_url('public/assets/img/users/2.jpg'); ?>">
															<div>
																<h6 class="tx-13 tx-inverse tx-semibold mg-b-0">Adrian Monino</h6><span class="d-block tx-11 text-muted">Premium Member</span>
															</div>
														</li>
														<li class="list-group-item d-flex align-items-center">
															<img alt="avatar" class="wd-30 rounded-circle mg-r-15" src="<?php echo base_url('public/assets/img/users/3.jpg'); ?>">
															<div>
																<h6 class="tx-13 tx-inverse tx-semibold mg-b-0">Joel Mendez</h6><span class="d-block tx-11 text-muted">Premium Member</span>
															</div>
														</li>
														<li class="list-group-item d-flex align-items-center">
															<img alt="avatar" class="wd-30 rounded-circle mg-r-15" src="<?php echo base_url('public/assets/img/users/4.jpg'); ?>">
															<div>
