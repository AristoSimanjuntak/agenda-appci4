										...
										<div class="text-wrap">
											<div class="example">
												<div class="demo-avatar-group">
													...
													<div class="main-img-user avatar-md">
														<img alt="avatar" class="square" src="<?php echo base_url('public/assets/img/users/5.jpg'); ?>">
													</div>
													<div class="main-img-user avatar-md">
														<img alt="avatar" class="radius" src="<?php echo base_url('public/assets/img/users/6.jpg'); ?>">
													</div>
												</div>
											</div>
	<!-- Prism Precode -->
											...
											<div class="example">
												<div class="demo-avatar-group">
													<div class="main-avatar avatar online">
														<img alt="avatar" class="rounded-circle avatar" src="<?php echo base_url('public/assets/img/users/9.jpg'); ?>">
													</div>
