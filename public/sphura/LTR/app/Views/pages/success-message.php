					...
					<div class="card alert-message">
						<div class="card-body">
							<div class="text-center text-white">
								...
								<p class="tx-18 text-white-50">Well Done!! You access this  page which is available..</p>
								<a href="<?php echo base_url('pages/index'); ?>" class="btn btn-success">Back to Home</a>
							</div>
						</div>
					</div>
				</div>
