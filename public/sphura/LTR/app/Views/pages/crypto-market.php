									...
									<div class="card-body pb-3">
										...
										<div class="d-flex">
											<div class="">
												...
												<div class="d-flex text-muted tx-13"><span class="text-success mr-2 font-weight-bold">-0.12%</span> Volume - 34,462.57 USDT</div>
											</div>
											<div class="d-flex ml-auto float-right">
												<canvas id="ltc-market" class="wd-50p wd-100-f ml-auto float-right"></canvas>
											</div>
										</div>
									</div>
								</div>
												...
												<table class="table table-1 text-nowrap">
													...
													<tbody>
														<tr class="border-bottom">
															<td>1</td>
															<td><img src="<?php echo  base_url('public/assets/img/svgs/crypto-currencies/btc.svg'); ?>" class="wd-30 ht-30 mr-3" alt="">Bitcoin <b>BTC</b></td>
															<td>$ 10513.00</td>
														...
														<tr class="border-bottom">
															<td>2</td>
															<td><img src="<?php echo  base_url('public/assets/img/svgs/crypto-currencies/eth.svg'); ?>" class="wd-30 ht-30 mr-3" alt="">Ethereum <b>ETH</b></td>
															<td>$ 425.25</td>
															<td>$ 4,48,308,110</td>
														...
														<tr class="border-bottom">
															<td>3</td>
															<td><img src="<?php echo  base_url('public/assets/img/svgs/crypto-currencies/xrp.svg'); ?>" class="wd-30 ht-30 mr-3" alt="">Ripple <b>XRP</b></td>
															<td>$ 1.2029</td>
															<td>$ 7,63,80,043</td>
														...
														<tr class="border-bottom">
															<td>4</td>
															<td><img src="<?php echo  base_url('public/assets/img/svgs/crypto-currencies/ltc.svg'); ?>" class="wd-30 ht-30 mr-3" alt="">litecoin <b>LTC</b></td>
															<td>$ 1547.67</td>
															<td>$ 6,14,18,730</td>
														...
														<tr class="border-bottom">
															<td>5</td>
															<td><img src="<?php echo  base_url('public/assets/img/svgs/crypto-currencies/neo.svg'); ?>" class="wd-30 ht-30 mr-3" alt="">Neo <b>NEO</b></td>
															<td>$ 723.48</td>
															<td>$ 19,07,67,295</td>
														...
														<tr class="border-bottom">
															<td>6</td>
															<td><img src="<?php echo  base_url('public/assets/img/svgs/crypto-currencies/xmr.svg'); ?>" class="wd-30 ht-30 mr-3" alt="">Monero <b>XMR</b></td>
															<td>$ 305.16</td>
															<td>$ 4,778,157,533</td>
														...
														<tr class="border-bottom">
															<td>7</td>
															<td><img src="<?php echo  base_url('public/assets/img/svgs/crypto-currencies/eos.svg'); ?>" class="wd-30 ht-30 mr-3" alt="">EOS <b>EOS</b></td>
															<td>$ 149.18</td>
															<td>$ 8,44,49,000</td>
														...
														<tr class="border-bottom">
															<td>8</td>
															<td><img src="<?php echo  base_url('public/assets/img/svgs/crypto-currencies/steem.svg'); ?>" class="wd-30 ht-30 mr-3" alt="">Steem <b>Steem</b></td>
															<td>$ 0.467813</td>
															<td>$ 8,358,735,080</td>
															<td><span class="text-success">+3.49%</span></td>
															<td><a href="#" class="btn btn-outline-primary btn-sm">Trade</a></td>
														...
														<tr class="border-bottom">
															<td>9</td>
															<td><img src="<?php echo  base_url('public/assets/img/svgs/crypto-currencies/miota.svg'); ?>" class="wd-30 ht-30 mr-3" alt="">Iota <b>IOTA</b></td>
															<td>$ 2.34</td>
															<td>$ 6,504,100,862</td>
														...
														<tr class="border-bottom">
															<td>10</td>
															<td><img src="<?php echo  base_url('public/assets/img/svgs/crypto-currencies/dash.svg'); ?>" class="wd-30 ht-30 mr-3" alt="">Dash <b>DASH</b></td>
															<td>$ 747.222</td>
															<td>$ 5,881,413,815</td>
														...
														<tr class="border-bottom">
															<td>11</td>
															<td><img src="<?php echo  base_url('public/assets/img/svgs/crypto-currencies/waves.svg'); ?>" class="wd-30 ht-30 mr-3" alt="">Waves <b>NEM</b></td>
															<td>$ 181.39</td>
															<td>$ 3,084,108,676</td>
