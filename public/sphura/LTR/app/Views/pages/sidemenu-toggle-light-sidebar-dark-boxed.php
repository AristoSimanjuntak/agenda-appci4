<?= $this->extend('layouts/layout-versions/sidemenu-toggle-light-sidebar-dark-boxed'); ?>
										...
										<div class="card bg-primary custom-card card-box">
											<div class="card-body p-4">
												<div class="row align-items-center">
													...
													<img src="<?php echo base_url('public/assets/img/pngs/work3.png'); ?>" alt="user-img" class="wd-200" >
												</div>
											</div>
										</div>
									</div>
															...
															<tr>
																...
																<td class="text-nowrap">
																	<div class="demo-avatar-group my-auto float-right">
																		...
																		<div class="main-img-user avatar-sm">
																			<img alt="avatar" class="rounded-circle" src="<?php echo base_url('public/assets/img/users/2.jpg'); ?>">
																		</div>
																		<div class="main-img-user avatar-sm">
																			<img alt="avatar" class="rounded-circle" src="<?php echo base_url('public/assets/img/users/3.jpg'); ?>">
																		</div>
																		<div class="main-img-user avatar-sm">
															...
															<tr>
																...
																<td class="text-nowrap">
																	<div class="demo-avatar-group my-auto float-right">
																		...
																		<div class="main-img-user avatar-sm">
																			<img alt="avatar" class="rounded-circle" src="<?php echo base_url('public/assets/img/users/12.jpg'); ?>">
																		</div>
																		<div class="main-img-user avatar-sm">
									...
									<table class="table table-hover m-b-0 transcations mt-2">
										<tbody>
											<tr>
												<td class="wd-5p">
													<div class="main-img-user avatar-md">
														<img alt="avatar" class="rounded-circle mr-3" src="<?php echo base_url('public/assets/img/users/5.jpg'); ?>">
													</div>
												</td>
												<td>
											 ...
											 <tr>
												<td class="wd-5p">
													<div class="main-img-user avatar-md">
														<img alt="avatar" class="rounded-circle mr-3" src="<?php echo base_url('public/assets/img/users/6.jpg'); ?>">
													</div>
												</td>
												<td>
													<div class="d-flex align-middle ml-3">
											...
											<tr>
												<td class="wd-5p">
													<div class="main-img-user avatar-md">
														<img alt="avatar" class="rounded-circle mr-3" src="<?php echo base_url('public/assets/img/users/7.jpg'); ?>">
													</div>
												</td>
												<td>
													<div class="d-flex align-middle ml-3">
											...
											<tr>
												<td class="wd-5p">
													<div class="main-img-user avatar-md">
														<img alt="avatar" class="rounded-circle mr-3" src="<?php echo base_url('public/assets/img/users/8.jpg'); ?>">
													</div>
												</td>
												<td>
													<div class="d-flex align-middle ml-3">
											...
											<tr>
												<td class="wd-5p pb-0">
													<div class="main-img-user avatar-md">
														<img alt="avatar" class="rounded-circle mr-3" src="<?php echo base_url('public/assets/img/users/4.jpg'); ?>">
													</div>
												</td>
												<td class="pb-0">
													<div class="d-flex align-middle ml-3">
								...
								<div class="card custom-card">
									<div class="card-body">
										<div class="row row-sm">
											...
											<div class="col-6">
												<img src="<?php echo base_url('public/assets/img/pngs/work.png'); ?>" alt="image" class="best-emp">
											</div>
										</div>
									</div>
								</div>
									...
									<div class="card-body">
										...
										<div class="row">
											...
											<div class="col col-auto">
												<div class="mt-3">
													<div class="">
														<img alt="" class="ht-50" src="<?php echo base_url('public/assets/img/media/project-logo.png'); ?>">
													</div>
												</div>
											</div>
										</div>
