			...
			<div class="main-header side-header hor-header top-header">
				<div class="container">
					<div class="main-header-left">
						...
						<a class="main-logo" href="index<?php echo base_url('pages/'); ?>">
					...
					<div class="main-header-center">
						<div class="responsive-logo">
							<a href="index<?php echo base_url('pages/'); ?>"><img src="<?php echo base_url('public/assets/img/brand/logo.png'); ?>" class="mobile-logo" alt="logo"></a>
							<a href="index<?php echo base_url('pages/'); ?>"><img src="<?php echo base_url('public/assets/img/brand/logo-light.png'); ?>" class="mobile-logo-dark" alt="logo"></a>
						</div>
					...
					<div class="main-header-right">
						...
						<a class="header-brand2" href="index<?php echo base_url('pages/'); ?>">
